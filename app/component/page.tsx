...
const components = [
  ...
  { name: 'create-new', category: 'navigation', isNew: true },
  { name: 'key button', category: 'buttons', isNew: true },
  { name: 'sparkle button', category: 'buttons', isNew: true },
  { name: 'firefly button', category: 'buttons', isNew: true },
  { name: 'command search', category: 'navigation', isNew: true },
  { name: 'glitch text', category: 'typography', isNew: true },
  { name: 'idea form', category: 'forms', isNew: true },
  { name: 'sign animation', category: 'animations', isNew: true },
  { name: 'feature card', category: 'cards', isNew: true },
  { name: 'hexagon hero', category: 'layout', isNew: true },
  { name: 'animated badge', category: 'badge', isNew: true },
