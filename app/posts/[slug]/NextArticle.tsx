...
export default function NextArticle({ currentSlug }: NextArticleProps) {
  ...
  return (
    ...
    >
      ...
      <div className="group relative cursor-pointer rounded-lg border-none bg-white p-4 transition-shadow duration-300 dark:bg-black">
        <div className="animate-gradient-x absolute inset-0 rounded-lg bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
        <div className="absolute inset-[2px] z-10 rounded-lg border bg-white dark:bg-black" />
        <div className="relative z-20 flex h-full items-center justify-between rounded-lg px-4 transition-all duration-300">
