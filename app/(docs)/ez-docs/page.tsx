...
function EzDocs() {
  return (
    <div className="flex flex-wrap justify-center gap-4 pb-10">
         ...
         <CardTitle className='text-4xl'>Easy Docs</CardTitle>
         <CardDescription className='text-lg'>Simplest implementation of Fumadocs.</CardDescription>
      ...
      <div className="sm:w-1/2 p-4">       
        <div className="flex justify-between">
          <Button className="w-1/2 px-4 py-4 mr-2 " type="submit" onClick={() => {
              ...
              link.href = 'https://github.com/DarkInventor/easy-docs/archive/refs/heads/main.zip';
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }} >Download Template</Button>
          <Button className="w-1/2 px-4 py-4 border shadow-sm ml-2 hover:bg-accent hover:text-accent-foreground " variant= "outline" type="submit"  onClick={() => window.open('https://easy-docs-lemon.vercel.app', '_blank')}>Live Preview<Icons.externalLink className="ml-1 p-1" /> </Button>
        </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-bold pt-10">Why Should I Use This Template?</h2>
        <p>Looking for a simple yet powerful documentation for your website to jumpstart your project? Easy Docs template is designed with the MDX, latest tech stack, offering a sleek, modern design that’s easy to use and configure. Here’s why this template is perfect for you:</p>
