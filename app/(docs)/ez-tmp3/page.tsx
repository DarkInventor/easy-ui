...
function EzPage() {
  return (
    <div className="flex flex-wrap justify-center gap-4 pb-10">
         ...
         <CardTitle className='text-4xl'>Easy Template 3</CardTitle>
         <CardDescription className='text-lg'>Easy Aceternity UI Landing Page Template</CardDescription>
         </div>
      ...
      <div className="sm:w-1/2 p-4">       
        <div className="flex justify-between">
          <Button className="w-1/2 px-4 py-4 mr-2 " type="submit"  onClick={() => {
              ...
              link.href = 'https://github.com/DarkInventor/easy-template-3/archive/refs/heads/main.zip';
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }} >Download Template</Button>
          <Button className="w-1/2 px-4 py-4 border shadow-sm ml-2 hover:bg-accent hover:text-accent-foreground " variant= "outline" type="submit"  onClick={() => window.open('https://easy-template-3.vercel.app/', '_blank')}>Live Preview<Icons.externalLink className="ml-1 p-1" /> </Button>
        </div>
