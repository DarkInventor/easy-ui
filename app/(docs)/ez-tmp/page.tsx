  ...
  return (
    <div className="flex flex-wrap justify-center gap-4 pb-10">
      ...
      <div className="space-y-4">
        ...
        <p>Looking for a simple yet powerful website template to jumpstart your project? Our template is designed with the latest tech stack, offering a sleek, modern design that’s easy to use and configure. Here’s why this template is perfect for you:</p>
