...
function SearchCommandComponent() {
  ...
  const handleOpenInV0 = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault()
    window.open(`https://v0.dev/chat/api/open?url=https://easyui.pro/v0-preview/search-command.json`, '_blank')
  }
      ...
      <TabsList className="z-50 grow justify-start rounded-none bg-transparent p-0">
        ...
        <TabsContent value="code">
          <div className="flex flex-col space-y-4 ml-3 lg:ml-4 md:lg-3 z-0">
            ...
            <p className="font-semibold mt-5 tracking-tight leading-7">Step 1: Copy and paste the following code into your<span className="font-normal italic"> components/command-search.tsx</span></p>
