...
function EzWaitlist() {
  return (
    <div className="flex flex-wrap justify-center gap-4 pb-10">
         ...
         <CardTitle className='text-4xl'>Easy Waitlist</CardTitle>
         <CardDescription className='text-lg'>Ready-to-use Waitlist Page.</CardDescription>
         <Badge className="hidden sm:inline-block" variant="default">Recommended for people willing to pre-launch the product for finding PMF</Badge>
         </div>
      ...
      <div className="sm:w-1/2 p-4">       
        <div className="flex justify-between">
          <Button className="w-1/2 px-4 py-4 mr-2 " type="submit" onClick={() => {
              ...
              link.href = 'https://github.com/DarkInventor/easy-waitlist/archive/refs/heads/main.zip';
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }} >Download Template</Button>
          <Button className="w-1/2 px-4 py-4 border shadow-sm ml-2 hover:bg-accent hover:text-accent-foreground " variant= "outline" type="submit"  onClick={() => window.open('https://easy-waitlist.vercel.app/', '_blank')}>Live Preview<Icons.externalLink className="ml-1 p-1" /> </Button>
        </div>
