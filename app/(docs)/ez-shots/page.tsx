...
function EzShots() {
  return (
    <div className="flex flex-wrap justify-center gap-4 pb-10">
         ...
         <CardDescription className='text-lg'>Create Beautiful Images from your Screenshots</CardDescription>
         <Badge className="hidden sm:inline-block bg-green-500 text-white" variant="default"><a href="https://x.com/kathanmehtaa">Brought to you by Kathan with ❤️</a></Badge>
         </div>
      ...
      <div className="sm:w-1/2 p-4">       
        <div className="flex justify-between">
          <Button className="w-1/2 px-4 py-4 mr-2 " type="submit" onClick={() => {
              ...
              link.href = 'https://github.com/DarkInventor/easy-shots/archive/refs/heads/main.zip';
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }} >Download Template</Button>
          <Button className="w-1/2 px-4 py-4 border shadow-sm ml-2 hover:bg-accent hover:text-accent-foreground " variant= "outline" type="submit"  onClick={() => window.open('https://easy-shots.vercel.app/', '_blank')}>Live Preview<Icons.externalLink className="ml-1 p-1" /> </Button>
        </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-bold pt-10">Why Should I Use This Template?</h2>
        <p>Easily turn screenshots into stunning visuals. Perfect for presentations, social media, and marketing. No design skills needed.</p>
