...
<div className="flex flex-wrap justify-center gap-4 pb-10 max-w-full min-w-full px-2 lg:px-20">
     <div className="w-full sm:w-2/3 p-2 mt-3 space-y-4 lg:mt-5 md:lg-5">
        <CardTitle className="text-3xl tracking-tight leading-7">Easy Chatbot</CardTitle>
        <CardDescription className="text-balance text-lg text-muted-foreground">
          Chatbot Template for AI App builders.
        </CardDescription>
        <Badge className="hidden sm:inline-block" variant="default">
          Built for people willing to integrate chatbot or develop AI app.
        </Badge>
      </div>
       ...
       <div className="lg:min-w-[900px] px-1 lg:px-2 sm:w-1/2 p-1 lg:p-2 ">
        <video muted loop className="w-full h-auto border lg:border-none rounded-lg lg:rounded-xl shadow-2xl" autoPlay>
          <source
            src="https://pub-0cd6f9d4131f4f79ac40219248ae64db.r2.dev/easy-chatbot.mp4"
            type="video/mp4"
          />
        </video>
      </div>
        ...
        <div className="flex justify-between">
          <Button
            ...
            onClick={() => {
              ...
              link.href =
                "https://github.com/DarkInventor/easy-chatbot/archive/refs/heads/main.zip"
          ...
          <Button
            ...
            type="submit"
            onClick={() =>
              window.open("https://easy-chatbot-five.vercel.app/", "_blank")
            }
          >
            Live Preview
