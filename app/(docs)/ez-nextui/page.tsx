...
function EzNextUI() {
  return (
    <div className="flex flex-wrap justify-center gap-4 pb-10">
         ...
         <CardTitle className='text-4xl'>Easy NextUI</CardTitle>
         <CardDescription className='text-lg'>Make Beautiful Websites using Easy NextUI Template.</CardDescription>
         {/* <Badge className="hidden sm:inline-block" variant="default"></Badge> */}
         </div>
      ...
      <div className="sm:w-1/2 p-4">       
        <div className="flex justify-between">
          <Button className="w-1/2 px-4 py-4 mr-2 " type="submit" onClick={() => {
              ...
              link.href = 'https://github.com/DarkInventor/easy-nextui/archive/refs/heads/main.zip';
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }} >Download Template</Button>
          <Button className="w-1/2 px-4 py-4 border shadow-sm ml-2 hover:bg-accent hover:text-accent-foreground " variant= "outline" type="submit"  onClick={() => window.open('https://easy-nextui.vercel.app/', '_blank')}>Live Preview<Icons.externalLink className="ml-1 p-1" /> </Button>
        </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-bold pt-10">Why Should I Use This Template?</h2>
        <p>This template is built specially for NextUI Lovers ❤️, Indiehackers, Software Devs, and Software Entrepreneurs. Here’s why this template is perfect for you:</p>
